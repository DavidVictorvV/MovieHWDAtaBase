...
namespace MovieHW_Db.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class MoviesController : ControllerBase
    {
        private readonly MovieHW_DbContext _context;

        public MoviesController(MovieHW_DbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> PutMovie(Guid id, Movie movie)
        {
            ...
            dbMovie.MovieLength = movie.MovieLength;
